...
import { DIFFICULTY, WORLD } from "./config.js?v=a3";
import { TEAMS, buildSquad, teamById, ratingOf, ensureContrast, setCompetition, getCompetition } from "./teams.js?v=a3";
import { Input } from "./input.js?v=a3";
import { Camera } from "./camera.js?v=a3";
import { drawPitch, drawCrowdTopDown, drawBoards, drawIndoorPitch } from "./pitch.js?v=a3";
import { Match } from "./match.js?v=a3";
import { render as render25 } from "./render2d5.js?v=a3";
import * as season from "./seasonui.js?v=a3";
import * as shootout1v1 from "./shootout1v1.js?v=a3";
import * as commentary from "./commentary.js?v=a3";
import * as tournament from "./tournamentui.js?v=a3";
import * as sound from "./sound.js?v=a3";
import * as achievements from "./achievements.js?v=a3";
import * as startpage from "./startpage.js?v=a3";
