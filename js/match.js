...
import { WORLD, FIELD, MARGIN, GOAL, HALL, BALL, KICK, PLAYER, USER, DIFFICULTY_TEAMMATE } from "./config.js?v=x2";
import { Team } from "./team.js?v=x2";
import { Ball } from "./ball.js?v=x2";
import { computeAI } from "./ai.js?v=x2";
import { ensureContrast } from "./teams.js?v=x2";
