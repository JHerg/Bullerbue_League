...
import { WORLD, FIELD, MARGIN, GOAL, HALL, BALL, KICK, PLAYER, USER, DIFFICULTY_TEAMMATE } from "./config.js?v=w2";
import { Team } from "./team.js?v=w2";
import { Ball } from "./ball.js?v=w2";
import { computeAI } from "./ai.js?v=w2";
import { ensureContrast } from "./teams.js?v=w2";
