...
import { WORLD, FIELD, MARGIN, GOAL, BALL, KICK, PLAYER, USER, DIFFICULTY_TEAMMATE } from "./config.js?v=y";
import { Team } from "./team.js?v=y";
import { Ball } from "./ball.js?v=y";
import { computeAI } from "./ai.js?v=y";
import { ensureContrast } from "./teams.js?v=y";
