...
import { WORLD, FIELD, MARGIN, GOAL, HALL, BALL, KICK, PLAYER, USER, PX_PER_M, DIFFICULTY_TEAMMATE } from "./config.js?v=b10";
import { Team } from "./team.js?v=b10";
import { Ball } from "./ball.js?v=b10";
import { computeAI } from "./ai.js?v=b10";
import { ensureContrast } from "./teams.js?v=b10";
