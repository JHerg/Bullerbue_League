...
import { WORLD, FIELD, MARGIN, GOAL, HALL, BALL, KICK, PLAYER, USER, DIFFICULTY_TEAMMATE } from "./config.js?v=a4";
import { Team } from "./team.js?v=a4";
import { Ball } from "./ball.js?v=a4";
import { computeAI } from "./ai.js?v=a4";
import { ensureContrast } from "./teams.js?v=a4";
