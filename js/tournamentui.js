...
import { allPlayers, teamById as teamDef } from "./teams.js?v=b3";
import { DIFFICULTY } from "./config.js?v=b3";
import * as T from "./tournament.js?v=b3";
import { saveSeason, loadSeason } from "./storage.js?v=b3";
