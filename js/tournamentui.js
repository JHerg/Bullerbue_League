...
import { allPlayers, teamById as teamDef } from "./teams.js?v=l2";
import { DIFFICULTY } from "./config.js?v=l2";
import * as T from "./tournament.js?v=l2";
import { saveSeason, loadSeason } from "./storage.js?v=l2";
