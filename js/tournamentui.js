...
import { allPlayers, teamById as teamDef } from "./teams.js?v=w2";
import { DIFFICULTY } from "./config.js?v=w2";
import * as T from "./tournament.js?v=w2";
import { saveSeason, loadSeason } from "./storage.js?v=w2";
