...
import { allPlayers, teamById as teamDef } from "./teams.js?v=y2";
import { DIFFICULTY } from "./config.js?v=y2";
import * as T from "./tournament.js?v=y2";
import { saveSeason, loadSeason } from "./storage.js?v=y2";
