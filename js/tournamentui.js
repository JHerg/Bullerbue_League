...
import { allPlayers, teamById as teamDef } from "./teams.js?v=a6";
import { DIFFICULTY } from "./config.js?v=a6";
import * as T from "./tournament.js?v=a6";
import { saveSeason, loadSeason } from "./storage.js?v=a6";
