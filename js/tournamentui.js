...
import { allPlayers, teamById as teamDef } from "./teams.js?v=a9";
import { DIFFICULTY } from "./config.js?v=a9";
import * as T from "./tournament.js?v=a9";
import { saveSeason, loadSeason } from "./storage.js?v=a9";
