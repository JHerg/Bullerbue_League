...
import { allPlayers, teamById as teamDef } from "./teams.js?v=z2";
import { DIFFICULTY } from "./config.js?v=z2";
import * as T from "./tournament.js?v=z2";
import { saveSeason, loadSeason } from "./storage.js?v=z2";
