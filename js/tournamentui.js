...
import { allPlayers, teamById as teamDef } from "./teams.js?v=p2";
import { DIFFICULTY } from "./config.js?v=p2";
import * as T from "./tournament.js?v=p2";
import { saveSeason, loadSeason } from "./storage.js?v=p2";
