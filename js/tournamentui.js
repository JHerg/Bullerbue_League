...
import { allPlayers, teamById as teamDef } from "./teams.js?v=m2";
import { DIFFICULTY } from "./config.js?v=m2";
import * as T from "./tournament.js?v=m2";
import { saveSeason, loadSeason } from "./storage.js?v=m2";
