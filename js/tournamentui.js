...
import { allPlayers, teamById as teamDef } from "./teams.js?v=a3";
import { DIFFICULTY } from "./config.js?v=a3";
import * as T from "./tournament.js?v=a3";
import { saveSeason, loadSeason } from "./storage.js?v=a3";
