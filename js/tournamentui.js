...
import { allPlayers, teamById as teamDef } from "./teams.js?v=r2";
import { DIFFICULTY } from "./config.js?v=r2";
import * as T from "./tournament.js?v=r2";
import { saveSeason, loadSeason } from "./storage.js?v=r2";
