...
import { allPlayers, teamById as teamDef } from "./teams.js?v=x2";
import { DIFFICULTY } from "./config.js?v=x2";
import * as T from "./tournament.js?v=x2";
import { saveSeason, loadSeason } from "./storage.js?v=x2";
