...
import { allPlayers, teamById as teamDef } from "./teams.js?v=b2";
import { DIFFICULTY } from "./config.js?v=b2";
import * as T from "./tournament.js?v=b2";
import { saveSeason, loadSeason } from "./storage.js?v=b2";
