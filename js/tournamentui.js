...
import { allPlayers, teamById as teamDef } from "./teams.js?v=k2";
import { DIFFICULTY } from "./config.js?v=k2";
import * as T from "./tournament.js?v=k2";
import { saveSeason, loadSeason } from "./storage.js?v=k2";
