...
import { allPlayers, teamById as teamDef } from "./teams.js?v=q2";
import { DIFFICULTY } from "./config.js?v=q2";
import * as T from "./tournament.js?v=q2";
import { saveSeason, loadSeason } from "./storage.js?v=q2";
