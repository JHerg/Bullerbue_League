...
import { allPlayers, teamById as teamDef } from "./teams.js?v=a8";
import { DIFFICULTY } from "./config.js?v=a8";
import * as T from "./tournament.js?v=a8";
import { saveSeason, loadSeason } from "./storage.js?v=a8";
