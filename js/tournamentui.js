...
import { allPlayers, teamById as teamDef } from "./teams.js?v=j2";
import { DIFFICULTY } from "./config.js?v=j2";
import * as T from "./tournament.js?v=j2";
import { saveSeason, loadSeason } from "./storage.js?v=j2";
