...
import { allPlayers, teamById as teamDef } from "./teams.js?v=a7";
import { DIFFICULTY } from "./config.js?v=a7";
import * as T from "./tournament.js?v=a7";
import { saveSeason, loadSeason } from "./storage.js?v=a7";
