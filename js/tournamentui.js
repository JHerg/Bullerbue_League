...
import { allPlayers, teamById as teamDef } from "./teams.js?v=u2";
import { DIFFICULTY } from "./config.js?v=u2";
import * as T from "./tournament.js?v=u2";
import { saveSeason, loadSeason } from "./storage.js?v=u2";
