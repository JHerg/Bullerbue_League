...
import { allPlayers, teamById as teamDef } from "./teams.js?v=b4";
import { DIFFICULTY } from "./config.js?v=b4";
import * as T from "./tournament.js?v=b4";
import { saveSeason, loadSeason } from "./storage.js?v=b4";
