...
import { allPlayers, teamById as teamDef } from "./teams.js?v=v2";
import { DIFFICULTY } from "./config.js?v=v2";
import * as T from "./tournament.js?v=v2";
import { saveSeason, loadSeason } from "./storage.js?v=v2";
